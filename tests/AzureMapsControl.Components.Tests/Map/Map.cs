...
public class MapTests
{
    ...
    {
        const string id = "id";
        var map = new AzureMap(id, _jsRuntimeMock.Object, _loggerMock.Object);
    ...
    public async Task Should_AddHtmlMarkers_Async()
    {
        ...
        var map = new AzureMap("id", _jsRuntimeMock.Object, _loggerMock.Object, htmlMarkerInvokeHelper: new HtmlMarkerInvokeHelper(eventArgs => ValueTask.CompletedTask), popupInvokeHelper: popupInvokeHelper);
    ...
    {
        var map = new AzureMap("id", _jsRuntimeMock.Object, _loggerMock.Object, htmlMarkerInvokeHelper: new HtmlMarkerInvokeHelper(eventArgs => ValueTask.CompletedTask));
    ...
    public async Task Should_AddDrawingToolbar_Async()
    {
        ...
        var map = new AzureMap("id", _jsRuntimeMock.Object, _loggerMock.Object, new DrawingToolbarEventInvokeHelper(eventArgs => ValueTask.CompletedTask));
    ...
    public async Task Should_AddALayer_Async()
    {
        ...
        var map = new AzureMap("id", _jsRuntimeMock.Object, _loggerMock.Object, layerEventInvokeHelper: new LayerEventInvokeHelper(eventArgs => ValueTask.CompletedTask));
    ...
    public async Task Should_AddDataSource_Async()
    {
        ...
        var map = new AzureMap("id", _jsRuntimeMock.Object, _loggerMock.Object, dataSourceEventInvokeHelper: new DataSourceEventInvokeHelper(_ => ValueTask.CompletedTask));
    ...
    public async Task Should_AddPopup_Async()
    {
        ...
        var map = new AzureMap("id", _jsRuntimeMock.Object, _loggerMock.Object, popupInvokeHelper: new PopupInvokeHelper(eventArgs => ValueTask.CompletedTask));
    ...
    {
        var map = new AzureMap("id", _jsRuntimeMock.Object);
