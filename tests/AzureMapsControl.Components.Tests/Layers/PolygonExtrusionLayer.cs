namespace AzureMapsControl.Components.Tests.Layers
{
    ...
    public class PolygonExtrusionLayerTests
    {
        [Fact]
        public void Should_HaveDefaultId()
        {
            var layer = new PolygonExtrusionLayer();
            Assert.NotEmpty(layer.Id);
            Assert.Equal(LayerType.PolygonExtrusionLayer, layer.Type);
        ...
        {
            const string id = "id";
            var layer = new PolygonExtrusionLayer(id);
